...
# Scenes
const SCENE_MANAGER:PackedScene = preload("res://addons/godot_landscaper/editor_only/scene_manager/scene_manager.tscn")
const ASSETS_MANAGER:PackedScene = preload("res://addons/godot_landscaper/editor_only/assets_manager/assets_manager.tscn")

const ICONS:Texture2D = preload("res://addons/godot_landscaper/editor_only/assets_manager/ui/icons.svg")

# Databases
const ASSETS_ROOT:String = "res://addons/godot_landscaper/editor_only/assets_manager/"
